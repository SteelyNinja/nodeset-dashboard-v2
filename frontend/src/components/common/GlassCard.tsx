...
const GlassCard: React.FC<GlassCardProps> = ({ 
  ...
  const getHoverStyles = () => {
    ...
    switch (elevation) {
      ...
      case 'raised':
        return `${baseHover} hover:shadow-md hover:border-white/15 dark:hover:border-white/20 hover:from-primary-500/10 hover:to-secondary-500/10 dark:hover:from-primary-400/12 dark:hover:to-secondary-400/12`;
      case 'elevated':
        return `${baseHover} hover:shadow-lg hover:border-white/20 dark:hover:border-white/25 hover:from-primary-500/10 hover:to-secondary-500/10 dark:hover:from-primary-400/12 dark:hover:to-secondary-400/12`;
      case 'floating':
