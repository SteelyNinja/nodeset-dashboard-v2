...
const GlassCard: React.FC<GlassCardProps> = ({ 
  ...
  const elevationStyles = {
    flat: {
      ...
      bg: 'bg-gradient-to-br from-primary-500/3 to-secondary-500/3 dark:from-primary-400/5 dark:to-secondary-400/5'
    },
    raised: {
      shadow: 'shadow-sm',
      border: 'border-white/10 dark:border-white/15',
      backdrop: 'backdrop-blur-[10px] dark:backdrop-blur-[15px]',
      bg: 'bg-gradient-to-br from-primary-500/5 to-secondary-500/5 dark:from-primary-400/8 dark:to-secondary-400/8'
    },
    elevated: {
      shadow: 'shadow-md',
      border: 'border-white/15 dark:border-white/20',
      backdrop: 'backdrop-blur-[15px] dark:backdrop-blur-[20px]',
      bg: 'bg-gradient-to-br from-primary-500/8 to-secondary-500/8 dark:from-primary-400/12 dark:to-secondary-400/12'
    },
    floating: {
      ...
      bg: 'bg-gradient-to-br from-primary-500/10 to-secondary-500/10 dark:from-primary-400/15 dark:to-secondary-400/15'
    }
  };
  ...
  const getHoverStyles = () => {
    ...
    switch (elevation) {
      ...
      case 'raised':
        return `${baseHover} hover:shadow-md hover:border-white/15 dark:hover:border-white/20 hover:from-primary-500/8 hover:to-secondary-500/8 dark:hover:from-primary-400/12 dark:hover:to-secondary-400/12`;
      case 'elevated':
        return `${baseHover} hover:shadow-lg hover:border-white/20 dark:hover:border-white/25 hover:from-primary-500/10 hover:to-secondary-500/10 dark:hover:from-primary-400/15 dark:hover:to-secondary-400/15`;
      case 'floating':
