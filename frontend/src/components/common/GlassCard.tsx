...
const GlassCard: React.FC<GlassCardProps> = ({ 
  ...
  // Elevation styles - consistent background opacity for better visual cohesion
  const elevationStyles = {
    flat: {
      shadow: 'shadow-none',
      border: 'border-white/5 dark:border-white/10',
      backdrop: 'backdrop-blur-[5px]',
      bg: 'bg-gradient-to-br from-primary-500/4 to-secondary-500/4 dark:from-primary-400/6 dark:to-secondary-400/6'
    },
    raised: {
      shadow: 'shadow-sm',
      border: 'border-white/10 dark:border-white/15',
      backdrop: 'backdrop-blur-[10px] dark:backdrop-blur-[15px]',
      bg: 'bg-gradient-to-br from-primary-500/6 to-secondary-500/6 dark:from-primary-400/8 dark:to-secondary-400/8'
    },
    elevated: {
      shadow: 'shadow-md',
    ...
    floating: {
      ...
      bg: 'bg-gradient-to-br from-primary-500/8 to-secondary-500/8 dark:from-primary-400/10 dark:to-secondary-400/10'
    }
  };
  ...
  const getHoverStyles = () => {
    ...
    switch (elevation) {
      ...
      case 'raised':
        return `${baseHover} hover:shadow-md hover:border-white/15 dark:hover:border-white/20 hover:from-primary-500/8 hover:to-secondary-500/8 dark:hover:from-primary-400/10 dark:hover:to-secondary-400/10`;
      case 'elevated':
        return `${baseHover} hover:shadow-lg hover:border-white/20 dark:hover:border-white/25 hover:from-primary-500/8 hover:to-secondary-500/8 dark:hover:from-primary-400/10 dark:hover:to-secondary-400/10`;
      case 'floating':
